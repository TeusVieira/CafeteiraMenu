...
public class Main {
    ...
    public static void searchFuncio(int id){
        funcionario procuradoF = new funcionario();
        procuradoF = DAOfactory.createFuncionarioDao().procurarFuncionario(id);
        System.out.println(procuradoF.toString());
    }
    ...
    public static void searchProduto(int id){
        produto procuradoP = new produto();
        procuradoP = DAOfactory.createProdutoDao().procurarPorId(id);
        System.out.println(procuradoP.toString());}
}